...
{
	/// <summary>
	/// Configuration section handler for Berkeley Db storage.
	/// </summary>
	internal class BerkeleyDbSectionHandler : IConfigurationSectionHandler
	{
	...
	/// <summary>
	/// Provides configuration for a Berkeley Db section.
	/// </summary>
